...
[<img width="140" height="28" alt="Deploy on Flux" src="https://github.com/user-attachments/assets/782abbc4-106a-4221-b87c-2879d5cc3400" />](https://orbit.app.runonflux.io/?repo=https://github.com/RunOnFlux/deploy-with-git&branch=master&projectPath=deploy-nextjs-mysql&plan=custom)

Or configure the deployment manually:

1. Open [Orbit](https://orbit.app.runonflux.io/).
2. Select this repository and use `deploy-nextjs-mysql/` as the project path.
