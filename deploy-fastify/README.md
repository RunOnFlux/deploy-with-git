# Deploying a Fastify App on Flux Network with Deploy With Git

This is a minimal Fastify 5 "Hello World" app ready to be deployed on [Flux Network](https://runonflux.com) using the [Deploy With Git](https://docs.runonflux.com/fluxcloud/register-new-app/deploy-with-git/) feature.
...
## How Flux Detects Your Fastify App
...
This project uses [esbuild](https://esbuild.github.io/) to bundle the Fastify app into a single `dist/server.js` file. Flux runs this as a persistent Node.js process and routes HTTP traffic to it.
...
[<img width="140" height="28" alt="deploy3" src="https://github.com/user-attachments/assets/782abbc4-106a-4221-b87c-2879d5cc3400" />](https://cloud.runonflux.io/apps/register/orbit?repo=https://github.com/RunOnFlux/deploy-with-git&branch=master&projectPath=deploy-fastify&plan=free)
...
4. Paste your **Repository URL**, select your **branch** and the **path** (e.g., `deploy-fastify/` if it's inside a monorepo), then click **Continue**
...
Set this to `3000` (the port Fastify listens on). Flux will route external traffic to this port.
