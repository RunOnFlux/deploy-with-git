# Deploying an MkDocs Site on Flux Network with Deploy With Git

This is a minimal MkDocs "Hello World" site ready to be deployed on [Flux Network](https://runonflux.com) using the [Deploy With Git](https://docs.runonflux.com/fluxcloud/register-new-app/deploy-with-git/) feature.
...
## How Flux Detects Your MkDocs Site
...
[<img width="140" height="28" alt="deploy3" src="https://github.com/user-attachments/assets/782abbc4-106a-4221-b87c-2879d5cc3400" />](https://cloud.runonflux.io/apps/register/orbit?repo=https://github.com/RunOnFlux/deploy-with-git&branch=master&projectPath=deploy-mkdocs&plan=free)
...
4. Paste your **Repository URL**, select your **branch** and the **path** (e.g., `deploy-mkdocs/` if it's inside a monorepo), then click **Continue**
...
|---|---|---|
| `BUILD_COMMAND` | Custom build command | `mkdocs build` (via `post-build.sh`) |
...
This project uses a `post-build.sh` hook to build the MkDocs site after dependencies are installed:
