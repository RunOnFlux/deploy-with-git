# Deploying an Iris App on Flux Network with Deploy With Git

This is a minimal Iris "Hello World" app ready to be deployed on [Flux Network](https://runonflux.com) using the [Deploy With Git](https://docs.runonflux.com/fluxcloud/register-new-app/deploy-with-git/) feature.
...
## How Flux Detects Your Iris App
...
[<img width="140" height="28" alt="deploy3" src="https://github.com/user-attachments/assets/782abbc4-106a-4221-b87c-2879d5cc3400" />](https://orbit.app.runonflux.io/?repo=https://github.com/RunOnFlux/deploy-with-git-samples&branch=master&projectPath=iris&plan=free)
...
4. Paste your **Repository URL**, select your **branch** and the **path** (e.g., `iris/` if it's inside a monorepo), then click **Continue**
...
Flux auto-detects the Go version from `.go-version` in your repository. Only fill this in if you need a specific version. This project includes a `.go-version` file pinning Go 1.22, so no manual selection is needed.
...
| `GO_VERSION` | Go version to use | `1.22` (from `.go-version`) |
